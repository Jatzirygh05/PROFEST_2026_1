                    ...
                    <div class="tab-content">
                      ...
                      <?php $query_user2="SELECT * FROM mas_presupuesto WHERE clave_usuario='".$cve_user."';";
                        ...
                        <td>
                          ...
                          -->
                          <input class="form-control" id="Monto_unidad<?=$h?>" name="Monto_unidad<?=$h?>" value="<?=$Monto_unidad?>" placeholder="0.00" type="text" onChange="sumaVerticalmonto(<?=$h?>, <?=$cuantos?>);calc_porcentaje2026(<?=$h?>, <?=$cuantos?>)" onKeyPress="return evita_comas(event)">
                        </td>
                        <td>
