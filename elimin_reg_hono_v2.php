...
$q_eli="DELETE FROM `honorarios_artisticos_academicos_v2` WHERE `id`=$clave_reg;";
$exe_delete=mysqli_query($con, $q_eli);
if($exe_delete==1){
  //v2_honorarios_artisticos_academicos_v2021_conformacion convocatoria 2021 cambiada el 26/01/2022
