...
require_once('TCPDF-master/tcpdf.php');
		...
		$pdf->SetY(114.5);
		$pdf->SetX(103);	
		$pdf->writeHTMLCell(0, 0, '', '',$telefono_fijo_op.'&nbsp;&nbsp;&nbsp;&nbsp;<strong>Teléfono móvil:</strong>&nbsp;&nbsp;&nbsp; '.$telefono_movil_op, 0, 0, 0, true, 'L', false);
		...
		$pdf->SetY(246);
		$pdf->SetX(65);
		//$pdf->writeHTMLCell(0, 0, '', '',$nombre_grado_academico.' '.$nombre_titular.' '.$primer_apellido.' '.$segundo_apellido, 1, 0, 0, true, 'C', false);

		$pdf->MultiCell(90,4,$nombre_grado_academico.' '.$nombre_titular.' '.$primer_apellido.' '.$segundo_apellido,0,'C');
