...
<body>
  <form name="formul" action="guardar_v2_formatos_honorarios.php" method="post">
     <div class="container">
        ...
        <div class="col-md-8"> 
          <table>
            ...
            <tr bgcolor="#F6F6F6">
              ...
              <td><span class="es inline-block">Fecha presentación*<br><strong>dd/mm/aaaa</strong></span></td>
            ...
            <tr>
              ...
              <?php
                ...
                ?>
                  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
      <td>
        h = <input type="text" name="" value="<?php echo $h; ?>">-
      ...
      <td>
        <select name="confir_tenta__<?php echo $consec; ?>__<?php echo $id; ?>" id="confir_tenta__<?php echo $consec; ?>__<?php echo $id; ?>" class="form-control honocampo">
        ...
        <td>
          ...
          <td><input type="text" class="form-control honocampo" name="nomb_art_gru__<?php echo $consec; ?>__<?php echo $id; ?>" id="nomb_art_gru__<?php echo $consec; ?>__<?php echo $id; ?>" value="<?php echo utf8_encode($fila10['nomb_art_gru']); ?>" placeholder="Ingresa" /></td>
          <td><input type="text" class="form-control honocampo" name="est_orig_art_gru__<?php echo $consec; ?>__<?php echo $id; ?>" id="est_orig_art_gru__<?php echo $consec; ?>__<?php echo $id; ?>" value="<?php echo utf8_encode($fila10['est_orig_art_gru']); ?>" placeholder="Ingresa" /></td>
          <td><input type="text" class="form-control honocampo" name="mun_orig_art_gru__<?php echo $consec; ?>__<?php echo $id; ?>" id="mun_orig_art_gru__<?php echo $consec; ?>__<?php echo $id; ?>" value="<?php echo utf8_encode($fila10['mun_orig_art_gru']); ?>" placeholder="Ingresa" /></td>
          <td><input type="text" class="form-control honocampo" name="tel_art_gru__<?php echo $consec; ?>__<?php echo $id; ?>" id="tel_art_gru__<?php echo $consec; ?>__<?php echo $id; ?>" value="<?php echo utf8_encode($fila10['tel_art_gru']); ?>" placeholder="Ingresa" /></td>
          <td><input type="text" class="form-control honocampo" name="email_art_gru__<?php echo $consec; ?>__<?php echo $id; ?>" id="email_art_gru__<?php echo $consec; ?>__<?php echo $id; ?>" value="<?php echo utf8_encode($fila10['email_art_gru']); ?>"  placeholder="ejemplo@dominio.com" /></td>
          <td><input type="text" class="form-control honocampo" name="reconoci_art_gru__<?php echo $consec; ?>__<?php echo $id; ?>" id="reconoci_art_gru__<?php echo $consec; ?>__<?php echo $id; ?>" value="<?php echo utf8_encode($fila10['reconoci_art_gru']); ?>" placeholder="Ingresa"/></td>
          <td><input type="text" class="form-control honocampo" name="pagweb_redes_art_gru__<?php echo $consec; ?>__<?php echo $id; ?>" id="pagweb_redes_art_gru__<?php echo $consec; ?>__<?php echo $id; ?>" value="<?php echo utf8_encode($fila10['pagweb_redes_art_gru']); ?>" placeholder="Ingresa"/></td>
          <td><select name="alcance__<?php echo $consec; ?>__<?php echo $id; ?>" id="alcance__<?php echo $consec; ?>__<?php echo $id; ?>" class="form-control honocampo">
                <option value="" selected>Selecciona una opción</option>
                <option value="Local" <?php if($fila10['alcance']=="Local"){ ?> selected <?php } ?>>Local</option>
                  ...
                  <td><select name="art_cuenta_CFDI__<?php echo $consec; ?>__<?php echo $id; ?>" id="art_cuenta_CFDI__<?php echo $consec; ?>__<?php echo $id; ?>" class="form-control honocampo">
                      <option value="" selected>Selecciona una opción</option>
                  ...
                  <td><input type="number" name="anio_exper_comproba__<?php echo $consec; ?>__<?php echo $id; ?>" id="anio_exper_comproba__<?php echo $consec; ?>__<?php echo $id; ?>" value="<?php echo utf8_encode($fila10['anio_exper_comproba']); ?>" class="form-control honocampo" placeholder="Ingresa" onKeyPress="return soloNumeros(event)" /></td>
                  <td><input type="text" name="nom_representante__<?php echo $consec; ?>__<?php echo $id; ?>" id="nom_representante__<?php echo $consec; ?>__<?php echo $id; ?>" value="<?php echo utf8_encode($fila10['nom_representante']); ?>" class="form-control honocampo" placeholder="Ingresa" /></td> 
                  <td><input type="text" name="tel_repr_fiscal__<?php echo $consec; ?>__<?php echo $id; ?>" id="tel_repr_fiscal__<?php echo $consec; ?>__<?php echo $id; ?>" value="<?php echo utf8_encode($fila10['tel_repr_fiscal']); ?>" class="form-control honocampo" placeholder="Ingresa" /></td>
                  <td><input type="text" name="email_repres_fiscal__<?php echo $consec; ?>__<?php echo $id; ?>" id="email_repres_fiscal__<?php echo $consec; ?>__<?php echo $id; ?>" value="<?php echo utf8_encode($fila10['email_repres_fiscal']); ?>" placeholder="ejemplo@dominio.com__<?php echo $id; ?>" class="form-control honocampo" /></td>
                  <td><select name="represent_fiscal_CFDI__<?php echo $consec; ?>__<?php echo $id; ?>" id="represent_fiscal_CFDI__<?php echo $consec; ?>__<?php echo $id; ?>" class="form-control honocampo">
                      <option value="" selected>Selecciona una opción</option>
                  ...
                  <td><select name="espacio__<?php echo $consec; ?>__<?php echo $id; ?>" id="espacio__<?php echo $consec; ?>__<?php echo $id; ?>" class="form-control honocampo">
                      <option value="" selected>Selecciona una opción</option>
                      <option value="Abierto" <?php if ($fila10['espacio']=='Abierto'){?> selected <?php } ?>>Abierto</option>
                      <option value="Cerrado" <?php if ($fila10['espacio']=='Cerrado'){?> selected <?php } ?>>Cerrado</option>
                      </select></td>                                
                  <td><input type="text" class="form-control honocampo" name="nomb_present__<?php echo $consec; ?>__<?php echo $id; ?>" id="nomb_present__<?php echo $consec; ?>__<?php echo $id; ?>" value="<?php echo utf8_encode($fila10['nomb_present']); ?>" placeholder="Ingresa" /></td>
                  <td>
                    <input type="text" class="form-control honocampo honofecha" name="fecha_present__<?php echo $consec; ?>__<?php echo $id; ?>" id="fecha_present__<?php echo $consec; ?>__<?php echo $id; ?>" value="<?php echo $fila10['fecha_present']; ?>" placeholder="Ingresa" maxlength="10">
  ...
  <input type="time" class="form-control honocampo" name="horario__<?php echo $consec; ?>__<?php echo $id; ?>" id="horario__<?php echo $consec; ?>__<?php echo $id; ?>" value="<?php echo $fila10['horario']; ?>" placeholder="Ingres el horario" step="1" size="5" class="form-control" />
                  ...
                  <td><input type="number" class="form-control honocampo" name="num_part_gru__<?php echo $consec; ?>__<?php echo $id; ?>" id="num_part_gru__<?php echo $consec; ?>__<?php echo $id; ?>" value="<?php echo $fila10['num_part_gru']; ?>" placeholder="Ingresa" onKeyPress="return soloNumeros(event)" /></td>
                  ...
                  ?>
                <select name="duracion__<?php echo $consec; ?>__<?php echo $id; ?>" id="duracion__<?php echo $consec; ?>__<?php echo $id; ?>" class="form-control honocampo">
                  ...
                  <td><input type="text" class="form-control honocampo" name="nomb_foro__<?php echo $consec; ?>__<?php echo $id; ?>" id="nomb_foro__<?php echo $consec; ?>__<?php echo $id; ?>" value="<?php echo utf8_encode($fila10['nomb_foro']); ?>" placeholder="Ingresa" /></td>
                  <td><input type="text" class="form-control honocampo" name="est_foro__<?php echo $consec; ?>__<?php echo $id; ?>" id="est_foro__<?php echo $consec; ?>__<?php echo $id; ?>" value="<?php echo utf8_encode($fila10['est_foro']); ?>" placeholder="Ingresa" /></td>
                  ...
                  <td><?php /*input type="text" class="form-control" name="publico_dir_prop_art__<?php echo $id; ?>" id="publico_dir_prop_art__<?php echo $id; ?>" value="<?php echo utf8_encode($fila10['publico']); ?>" placeholder="Ingresa" /*/?>
                    <select name="publico__<?php echo $consec; ?>__<?php echo $id; ?>" id="publico__<?php echo $consec; ?>__<?php echo $id; ?>" class="form-control honocampo">
                      <option value="" selected>Selecciona una opción</option>
                  ...
                  <td><input type="text" class="form-control honocampo" name="impacto_sociocultural__<?php echo $consec; ?>__<?php echo $id; ?>" id="impacto_sociocultural__<?php echo $consec; ?>__<?php echo $id; ?>" value="<?php echo utf8_encode($fila10['impacto_sociocultural']); ?>" placeholder="Ingresa" /></td> 
                  <td>
              <input type="text" class="form-control honocampo" name="sinopsis__<?php echo $consec; ?>__<?php echo $id; ?>" id="sinopsis__<?php echo $consec; ?>__<?php echo $id; ?>" value="<?php echo utf8_encode($fila10['sinopsis']); ?>" placeholder="Ingresa" maxlength="600">
                  ...
                  <td><input type="text" class="form-control honocampo" name="links_mat_videog_prop__<?php echo $consec; ?>__<?php echo $id; ?>" id="links_mat_videog_prop__<?php echo $consec; ?>__<?php echo $id; ?>" value="<?php echo utf8_encode($fila10['links_mat_videog_prop']); ?>" placeholder="Ingresa" /></td>
                  <td>
  <input type="text" class="form-control honocampo honocampomonto" name="monto__<?php echo $consec; ?>__<?php echo $id; ?>" id="monto__<?php echo $consec; ?>__<?php echo $id; ?>" value="<?php echo $fila10['monto']; ?>" placeholder="Ingresa" onKeyPress="return evita_comas(event)" /></td>
                  <td><input type="text" class="form-control honocampo" name="cuenta_apoyo_FONCA__<?php echo $consec; ?>__<?php echo $id; ?>" id="cuenta_apoyo_FONCA__<?php echo $consec; ?>__<?php echo $id; ?>" value="<?php echo utf8_encode($fila10['cuenta_apoyo_FONCA']); ?>"></td> 
                </tr>
                <?php }
                ...
                <tr>
                  ...
                  <td><select name="espacio__<?php echo $i; ?>" id="espacio__<?php echo $i; ?>" class="form-control honocampo">
                      <option value="" selected>Selecciona una opción</option>
                  ...
                  <td>
                    <input type="text" class="form-control honocampo honofecha" name="fecha_present__<?php echo $i; ?>" id="fecha_present__<?php echo $i; ?>" placeholder="dd/mm/aaaa" maxlength="10" /><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>
                  </td>
                  ...
                  <td><input class="form-control honocampo honocampomonto" type="text" name="monto__<?php echo $i; ?>" id="monto__<?php echo $i; ?>" placeholder="Ingresa" /></td>
 ...
 or `fecha_present` is null or length(fecha_present) = 0 
  ...
  or `espacio` is null or length(espacio) = 0;";
