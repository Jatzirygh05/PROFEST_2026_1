...
//if($level=="op"){ echo "<META HTTP-EQUIV='Refresh' CONTENT='2;URL=login_op.php'>";}
			...
			for ($k=0; $k <$num_resultados_proyecto; $k++)
			{
				...
				$cronograma_acciones_acciones1 = stripslashes($row_proy["cronograma_acciones_acciones1"]);
				$cronograma_acciones_fecha1    = stripslashes($row_proy["cronograma_acciones_fecha1"]);
				
				$cronograma_acciones_acciones2 = stripslashes($row_proy["cronograma_acciones_acciones2"]);
				$cronograma_acciones_fecha2    = stripslashes($row_proy["cronograma_acciones_fecha2"]);
				
				$cronograma_acciones_acciones3 = stripslashes($row_proy["cronograma_acciones_acciones3"]);
				$cronograma_acciones_fecha3    = stripslashes($row_proy["cronograma_acciones_fecha3"]);
				
				$Nombreforo_1		= stripslashes($row_proy["Nombreforo_1"]);
				$Domicilioforo_1	= stripslashes($row_proy["Domicilioforo_1"]);
				$Descripespacio_1	= stripslashes($row_proy["Descripespacio_1"]);

				$Nombreforo_2		= stripslashes($row_proy["Nombreforo_2"]);
				$Domicilioforo_2	= stripslashes($row_proy["Domicilioforo_2"]);
				$Descripespacio_2	= stripslashes($row_proy["Descripespacio_2"]);

				$Nombreforo_3		= stripslashes($row_proy["Nombreforo_3"]);
				$Domicilioforo_3	= stripslashes($row_proy["Domicilioforo_3"]);
				$Descripespacio_3	= stripslashes($row_proy["Descripespacio_3"]);
...
<!-- INICIO PESTAÑA "Solicitud" -->
  ...
  `poblacion_genero_hombre
  `poblacion_genero_mujer
  `poblacion_edad_0_12
  `poblacion_edad_13_17
  `poblacion_edad_18_29
  `poblacion_edad_30_59
  `poblacion_edad_60
  `poblacion_nivel_sin_escolaridad
  `poblacion_nivel_educ_basica
  `poblacion_nivel_educ_media
  `poblacion_nivel_educ_superior
  `poblacion_especific_reclusion
  `poblacion_especific_migrantes
  `poblacion_especific_indigenas
  `poblacion_especific_con_discapacidad
  `poblacion_especific_otros
  `estrategias_medios_radio
  `estrategias_medios_television
  `estrategias_medios_internet
  `estrategias_medios_redes_sociales
  `estrategias_medios_prensa
  `estrategias_medios_folletos_posters
  `estrategias_medios_espectaculares
  `estrategias_medios_perifoneo
  `estrategias_medios_otros
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td><input type="text" id="cronograma_acciones_fecha1" name="cronograma_acciones_fecha1" value="<?=$cronograma_acciones_fecha1?>" class="form-control proyectocampo" placeholder="Ingresa la fecha">
                                    <small id="errNombre_Inst" name="errNombre_Inst" class="form-text form-text-error" style="display:none">Este campo es obligatorio</small></td>
                         <td><input type="text" id="cronograma_acciones_acciones1" name="cronograma_acciones_acciones1" value="<?=$cronograma_acciones_acciones1?>" class="form-control proyectocampo" placeholder="Ingresa la acción">
                                    <small id="errNombre_Inst" name="errNombre_Inst" class="form-text form-text-error" style="display:none">Este campo es obligatorio</small></td>
                              </tr>
                              <tr>
                                <th scope="row">2<samp id="errnombre_titularAs" name="errnombre_titularAs" class="control-label">*</samp></th>
                                <td><input type="text" id="cronograma_acciones_fecha2" name="cronograma_acciones_fecha2" value="<?=$cronograma_acciones_fecha2?>" class="form-control proyectocampo" placeholder="Ingresa la fecha">
                                    <small id="errNombre_Inst" name="errNombre_Inst" class="form-text form-text-error" style="display:none">Este campo es obligatorio</small></td>
                         <td><input type="text" id="cronograma_acciones_acciones2" name="cronograma_acciones_acciones2" value="<?=$cronograma_acciones_acciones2?>" class="form-control proyectocampo" placeholder="Ingresa la acción">
                                    <small id="errNombre_Inst" name="errNombre_Inst" class="form-text form-text-error" style="display:none">Este campo es obligatorio</small></td>
                              </tr>
                              <tr>
                                <th scope="row">3<samp id="errnombre_titularAs" name="errnombre_titularAs" class="control-label">*</samp></th>
                                <td><input type="text" id="cronograma_acciones_fecha3" name="cronograma_acciones_fecha3" value="<?=$cronograma_acciones_fecha3?>" class="form-control proyectocampo" placeholder="Ingresa la fecha">
                                    <small id="errNombre_Inst" name="errNombre_Inst" class="form-text form-text-error" style="display:none">Este campo es obligatorio</small></td>
                         <td><input type="text" id="cronograma_acciones_acciones3" name="cronograma_acciones_acciones3" value="<?=$cronograma_acciones_acciones3?>" class="form-control proyectocampo" placeholder="Ingresa la acción">
                                    <small id="errNombre_Inst" name="errNombre_Inst" class="form-text form-text-error" style="display:none">Este campo es obligatorio</small></td>
                              </tr>
                                                            
            <?php 
			// INICIO PESTAÑA 'Cronograma' 
			$sql_consulta_crono = "SELECT id_cronograma_acciones, fechaacciones, acciones FROM cronograma_acciones_ejecucion_festival WHERE `clave_usuario` LIKE '".$cve_user."' "; 
			$resultado_consulta_crono = mysql_query($sql_consulta_crono);
			$num_resultados_cronograma = mysql_num_rows($resultado_consulta_crono);
			for ($p=0; $p <$num_resultados_cronograma; $p++)
			{
				$row_crono = mysql_fetch_array($resultado_consulta_crono);
				
				$id_cronograma = $row_crono["id_cronograma_acciones"];
				$fechaacciones 	= stripslashes($row_crono["fechaacciones"]);
				$acciones 		= stripslashes($row_crono["acciones"]);
				
			?>
              <tr>
                 <th scope="row"></th>
                 <td><input type="text" id="fechaacciones_<?=$id_cronograma?>" name="fechaacciones_<?=$id_cronograma?>" value="<?=$fechaacciones?>" class="form-control mas_cronograma_guardados" placeholder="Ingresa la fecha"></td>
                 <td><input type="text" id="acciones_<?=$id_cronograma?>" name="acciones_<?=$id_cronograma?>" value="<?=$acciones?>" class="form-control mas_cronograma_guardados" placeholder="Ingresa la acción"></td>
              </tr>              
			<?php
			}
			// FIN PESTAÑA 'Cronograma'
			?>
                            </tbody>
                          </table>
                          <div class="row">
                            <div class="col-md-4">
                               <div class="form-group">
                                            <label>Indica número de acciones para la ejecución del festival para agregar:</label>
                                            <input name="num2" type="number" id="num2" onkeyup="ctext2(this.value)" class="form-control" />
                               </div>
                    ...
                    <?php 
					$sql_cons_cuantos_id = "select id_cronograma_acciones from cronograma_acciones_ejecucion_festival 
					WHERE `clave_usuario` LIKE '".$cve_user."' order by id_cronograma_acciones asc limit 0,1"; 
					$resultado_sql_cons_cuantos_id = mysql_query($sql_cons_cuantos_id);
					$row_ultimo = mysql_fetch_array($resultado_sql_cons_cuantos_id);
						
					$ultimo_reg_crono_op = $row_ultimo["id_cronograma_acciones"]+1;
					if($ultimo_reg_crono==0){
							$ultimo_reg_crono=3;
					}
					...
					for($k=1;$k<=51;$k++){
						...
						$ultimo_reg_crono=$ultimo_reg_crono+$k;
						
							
					?>	  
                      <div style="display:none" id="div_<?=$k?>">
                        <div class="row">         	
                          <div class="col-md-4">
                            <div class="form-group">
                                <label>Fecha(<?=$ultimo_reg_crono?>)</label>
                              <input name="fechaacciones_<?=$ultimo_reg_crono?>" id="fechaacciones_<?=$ultimo_reg_crono?>" type="text" class="form-control mas_cronogramaactividades" placeholder="Ingresa la fecha" />
                            </div>
                          </div>
                        <div class="col-md-4">
                            <div class="form-group">
                             <label>Acciones(<?=$ultimo_reg_crono?>)</label>
                             <input name="acciones_<?=$ultimo_reg_crono?>" id="acciones_<?=$ultimo_reg_crono?>" type="text" class="form-control mas_cronogramaactividades" placeholder="Ingresa la acción"  />
                            </div>
                          </div>
                        </div>
                        </div>
                  ...
                  <div class="form-group"> 
                        <table class="table table-bordered">
                           ...
                           <div class="row">
                            <div class="col-md-4">
                               <div class="form-group">
                                            <label>Indica los lugares de realización para agregar:</label>
                                            <input name="num3" type="number" id="num3" onkeyup="ctext3(this.value)" class="form-control" />
                               </div>
                    ...
                    <?php for($m=1;$m<=50;$m++){ ?>	  
                      <div style="display:none" id="div_a_<?=$m?>">
                        <div class="row">         	
                          <div class="col-md-4">
                            <div class="form-group">
                                <label>Nombre del foro(<?=$m?>)</label>
                          <input name="Nombreforo_<?=$m?>" id="Nombreforo_<?=$m?>" type="text" class="form-control mas_lugares" placeholder="Ingresa el nombre del foro" />
                            </div>
                          </div>
                         <div class="col-md-4">
                            <div class="form-group">
                             <label>Domicilio(<?=$m?>)</label>
                         <input name="Domicilioforo_<?=$m?>" id="Domicilioforo_<?=$m?>" type="text" class="form-control mas_lugares" placeholder="Ingresa el domicilio"  />
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                             <label>Descripción(<?=$m?>)</label>
                 		<input name="Descripcionlug_<?=$m?>" id="Descripcionlug_<?=$m?>" type="text" class="form-control mas_lugares" placeholder="Ingresa la descripción mas_lugares"  />
                            </div>
                          </div>
                        </div>
                        </div>
