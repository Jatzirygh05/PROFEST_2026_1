...
<form METHOD="POST" id="apInf" name="apInf" action="guardar_v2_requerimientos_1_2.php">
<div class="row">
   <div class="col-md-12"> 
  ...
  <div class="row">
     ...
     <div class="col-md-4">
      <div class="checkbox">
          <label>
            <input type="checkbox" name="opcion8" id="opcion8" <?php if($clave8!=""){ ?> checked <?php } ?>  value="8"> Honorarios artísticos y académicos
          </label>
      </div>
      <?php if($disciplina_artes_visuales_v2==1 || $disciplina_literatura_v2==1){?>
       	<div class="checkbox">
          <label>
            <input type="checkbox" name="opcion1" id="opcion1" <?php if($clave1!=""){ ?> checked <?php } ?> value="1"> Arrendamiento de espacios, muebles e inmuebles
          </label>
        </div>
      <?php } ?>
      <div class="checkbox">
        <label>
            <input type="checkbox" name="opcion2" id="opcion2" <?php if($clave2!=""){ ?> checked <?php } ?>  value="2"> Arrendamiento de escenarios, iluminación, audio y requerimientos técnicos en general
        </label>
      </div>
      <div class="checkbox">
        <label>
          <input type="checkbox" name="opcion3" id="opcion3" <?php if($clave3!=""){ ?> checked <?php } ?>  value="3"> Derechos en general
        </label>
      </div>
      <div class="checkbox">
        <label>
          <input type="checkbox" name="opcion4" id="opcion4" <?php if($clave4!=""){ ?> checked <?php } ?>  value="4"> Seguridad (incluye gastos médicos, traslados de obra, instrumentos, etc.)
        </label>
      </div>
      ...
      <?php if($disciplina_musica_v2==1 || $disciplina_teatro_v2==1 || $disciplina_danza_v2==1 || $disciplina_gastronomia_v2==1){?>
        <div class="checkbox">
          <label>
            <input type="checkbox" name="opcion5" id="opcion5" <?php if($clave5!=""){ ?> checked <?php } ?>  value="5"> Transportación aérea de las/os participantes (No se cubren pérdidas de boletos, cambios de itinerarios, exceso de equipaje, ni acompañantes)
          </label>
        </div>
      <?php } ?>
      ...
      <div class="checkbox">
        <label>
          <input type="checkbox" name="opcion6" id="opcion6" <?php if($clave6!=""){ ?> checked <?php } ?>  value="6"> Servicios de subtitulaje y traducción
        </label>
      </div>
      <?php if($disciplina_gastronomia_v2==1){?>
        <div class="checkbox">
          <label>
            <input type="checkbox" name="opcion7" id="opcion7" <?php if($clave7!=""){ ?> checked <?php } ?>  value="7"> Insumos para actividades gastronómicas (Se sugiere el uso de artículos biodegradables)
          </label>
        </div>
      <?php } ?>
      ...
      <?php if($disciplina_artes_visuales_v2==1 || $disciplina_literatura_v2==1){?>
        <div class="checkbox">
          <label>
            <input type="checkbox" name="opcion9" id="opcion9" <?php if($clave9!=""){ ?> checked <?php } ?>  value="9"> Corte vinil para stands de exposición y/o foros
          </label>
        </div>
      <?php } ?>
    </div>
