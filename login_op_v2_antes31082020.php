           ...
           <div class="row">
			...
			<input class='form-control proyectocampo' type='text' name='Nombreforo_a' id='Nombreforo_a' value='<?=$Nombreforo_a?>' placeholder='Ingresa el nombre de foro o medio de transmisión'> 
             ...
             <div class="row">
                <div class="col-md-4">
                	<div class="form-group">
					<label class="control-label" for="tipo_lugar_b">Tipo de lugar<samp id="errtipo_lugar_bAs" name="errtipo_lugar_bAs" class="control-label">*</samp>:</label>
					    ...
					    <small id="errtipo_lugar_b" name="errtipo_lugar_b" class="form-text form-text-error" style="display:none">Este campo es obligatorio</small>
					</div> 
				</div>
			</div>
            <div class="row">
                	<div class="col-md-4">
                     <div class="form-group"> 
                    	<label>Nombre de foro o medio de transmisión<samp id="errNombreforo_bAs" name="errNombreforo_bAs" class="control-label">*</samp>:</label>
			<input class='form-control proyectocampo' type='text' name='Nombreforo_b' id='Nombreforo_b' value='<?=$Nombreforo_b?>' placeholder='Ingresa el nombre de foro o medio de transmisión'> 
                	...
                	<div class="col-md-4"> 
                       <div class="form-group">
                         <label class="control-label" for="Descripcionlug_b">Descripci&oacute;n y link de acceso, en su caso<samp id="errDescripcionlug_bAs" name="errDescripcionlug_bAs" class="control-label">*</samp>:</label>
                         <input class="form-control proyectocampo" id="Descripcionlug_b" name="Descripcionlug_b" value="<?=$Descripcionlug_b?>" placeholder="Descripci&oacute;n y link de acceso, en su caso" type="text">
                        <small id="errDescripcionlug_b" name="errDescripcionlug_b" class="form-text form-text-error" style="display:none">Este campo es obligatorio</small>
                       </div>
                    </div>
               </div>
               <div class="row"> 
                    <div class="col-md-4"> 
                       <div class="form-group">
                        <label class="control-label" for="cpforo_b">Código Postal<samp id="errcpforo_bAs" name="errcpforo_bAs" class="control-label">*</samp>:</label>
                        <input class="form-control proyectocampo" id="cpforo_b" name="cpforo_b" placeholder="Ingresa el Código Postal" value="<?=$cpforo_b?>" type="text" onKeyPress="return evita_comas(event)" <?php if($tipo_lugar_b==2){ ?> disabled <?php } ?>>
                        <small id="errcpforo_b" name="errcpforo_b" class="form-text form-text-error" style="display:none">Este campo es obligatorio</small>
                       </div>
                    </div>
                    <div class="col-md-4"> 
                       <div class="form-group">
                        <label class="control-label" for="estadoforo_b">Estado<samp id="errestadoforo_bAs" name="errestadoforo_bAs" class="control-label">*</samp>:</label>
                    ...
                    <div class="col-md-4"> 
                       <div class="form-group">
                  <label class="control-label" for="mun_alcforo_b">Municipio o Alcaldía<samp id="errmun_alcforo_bAs" name="errmun_alcforo_bAs" class="control-label">*</samp>:</label>
                ...
                <div class="row"> 
                    <div class="col-md-4"> 
                       <div class="form-group">
                        <label class="control-label" for="coloniaforo_b">Colonia<samp id="errcoloniaforo_bAs" name="errcoloniaforo_bAs" class="control-label">*</samp>:</label>
                    ...
                    <div class="col-md-4"> 
                       <div class="form-group">
                        <label class="control-label" for="calleforo_b">Calle<samp id="errcalleforo_bAs" name="errcalleforo_bAs" class="control-label">*</samp>:</label>
                    ...
                    <div class="col-md-4"> 
                       <div class="form-group">
                        <label class="control-label" for="no_extforo_b">No. exterior<samp id="errno_extforo_bAs" name="errno_extforo_bAs" class="control-label">*</samp>:</label>
                        <input class="form-control proyectocampo" id="no_extforo_b" name="no_extforo_b" placeholder="Ingresa el número externo" value="<?=$no_extforo_b?>" type="text" <?php if($tipo_lugar_b==2){ ?> disabled <?php } ?>>
                ...
                <div class="row"> 
                    <div class="col-md-4"> 
                       <div class="form-group">
                        <label class="control-label" for="no_intforo_b">No. interior<samp id="errno_intforo_bAs" name="errno_intforo_bAs" class="control-label">*</samp>:</label>
                        <input class="form-control proyectocampo" id="no_intforo_b" name="no_intforo_b" placeholder="Ingresa el número interno" value="<?=$no_intforo_b?>" type="text" <?php if($tipo_lugar_b==2){ ?> disabled <?php } ?>>
            ...
            <div class="row">
                <div class="col-md-4">
                	<div class="form-group">
					<label class="control-label" for="tipo_lugar_c">Tipo de lugar<samp id="errtipo_lugar_cAs" name="errtipo_lugar_cAs" class="control-label">*</samp>:</label>
					    ...
					    <small id="errtipo_lugar_c" name="errtipo_lugar_c" class="form-text form-text-error" style="display:none">Este campo es obligatorio</small>
					</div> 
				</div>
			</div>
			<div class="row">
                	<div class="col-md-4">
                     <div class="form-group"> 
                    	<label>Nombre de foro o medio de transmisión<samp id="errNombreforo_cAs" name="errNombreforo_cAs" class="control-label">*</samp>:</label>
			<input class='form-control proyectocampo' type='text' name='Nombreforo_c' id='Nombreforo_c' value='<?=$Nombreforo_c?>' placeholder='Ingresa el nombre de foro o medio de transmisión'> 
                        <small id="errNombreforo_c" name="errNombreforo_c" class="form-text form-text-error" style="display:none">Este campo es obligatorio</small>
                     </div>
                	</div>
                	<div class="col-md-4"> 
                       <div class="form-group">
                         <label class="control-label" for="Descripcionlug_c">Descripci&oacute;n y link de acceso, en su caso<samp id="errDescripcionlug_cAs" name="errDescripcionlug_cAs" class="control-label">*</samp>:</label>
                         <input class="form-control proyectocampo" id="Descripcionlug_c" name="Descripcionlug_c" value="<?=$Descripcionlug_c?>" placeholder="Descripci&oacute;n y link de acceso, en su caso" type="text">
                        <small id="errDescripcionlug_c" name="errDescripcionlug_c" class="form-text form-text-error" style="display:none">Este campo es obligatorio</small>
                       </div>
                    </div>
               </div>
               <div class="row"> 
                    <div class="col-md-4"> 
                       <div class="form-group">
                        <label class="control-label" for="cpforo_c">Código Postal<samp id="errcpforo_cAs" name="errcpforo_cAs" class="control-label">*</samp>:</label>
                    ...
                    <div class="col-md-4"> 
                       <div class="form-group">
                        <label class="control-label" for="estadoforo_c">Estado<samp id="errestadoforo_cAs" name="errestadoforo_cAs" class="control-label">*</samp>:</label>
                    ...
                    <div class="col-md-4"> 
                       <div class="form-group">
                  <label class="control-label" for="mun_alcforo_c">Municipio o Alcaldía<samp id="errmun_alcforo_cAs" name="errmun_alcforo_cAs" class="control-label">*</samp>:</label>
                ...
                <div class="row"> 
                    <div class="col-md-4"> 
                       <div class="form-group">
                        <label class="control-label" for="coloniaforo_c">Colonia<samp id="errcoloniaforo_cAs" name="errcoloniaforo_cAs" class="control-label">*</samp>:</label>
                    ...
                    <div class="col-md-4"> 
                       <div class="form-group">
                        <label class="control-label" for="calleforo_c">Calle<samp id="errcalleforo_cAs" name="errcalleforo_cAs" class="control-label">*</samp>:</label>
                    ...
                    <div class="col-md-4"> 
                       <div class="form-group">
                        <label class="control-label" for="no_extforo_c">No. exterior<samp id="errno_extforo_cAs" name="errno_extforo_cAs" class="control-label">*</samp>:</label>
                        <input class="form-control proyectocampo" id="no_extforo_c" name="no_extforo_c" placeholder="Ingresa el número externo" value="<?=$no_extforo_c?>" type="text" <?php if($tipo_lugar_c==2){ ?> disabled <?php } ?>>
                ...
                <div class="row"> 
                    <div class="col-md-4"> 
                       <div class="form-group">
                        <label class="control-label" for="no_intforo_c">No. interior<samp id="errno_intforo_cAs" name="errno_intforo_cAs" class="control-label">*</samp>:</label>
                        <input class="form-control proyectocampo" id="no_intforo_c" name="no_intforo_c" placeholder="Ingresa el número interno" value="<?=$no_intforo_c?>" type="text" <?php if($tipo_lugar_c==2){ ?> disabled <?php } ?>>
