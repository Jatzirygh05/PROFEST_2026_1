...
<!-- *********************PRIMERA PARTE********************* -->
      ...
      <!-- FIN PESTAÑA "Solicitud" -->  
        ...
        <div class="row">  
           ...
           <div class="col-md-4">
                ...
                <div class="form-group">
                  ...
                  <!-- Telefono -->
	                    ...
	                    <input type="text" id="telefono_fijo_op" name="telefono_fijo_op" value="<?=$telefono_fijo_op?>" class="form-control proyectocampo" placeholder="Teléfono fijo" maxlength="10">
          ...
          <div class="col-md-4">
                <div class="form-group">
                    <label>Teléfono móvil:</label><input type="text" id="telefono_movil_op" name="telefono_movil_op" value="<?=$telefono_movil_op?>" class="form-control proyectocampo" placeholder="Teléfono móvil" maxlength="10">
                </div>
            </div>
          	   <!-- Correo electronico -->
            <div class="col-md-4">
