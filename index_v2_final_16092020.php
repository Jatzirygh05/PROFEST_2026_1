...
<body>
    ...
    <div class="container bottom-buffer">
      <ol class="breadcrumb">
        ...
        <li><a href="https://profest.cultura.gob.mx/" onclick="uid_call('inicio', 'clickin')" class="active">Inicio</a></li>
      </ol>
      <div class="row">
        <div class="col-md-8">
          <div>
          ...
          <form class="form-horizontal ns_" role="form" name="form1" method="post" action="<?php echo $loginFormAction; ?>">
            ...
            <div class="form-group">
              <div class="col-sm-offset-3 col-sm-9" align="right">
                <a href='formatos_para_descarga_general/Manual_llenado_Plataforma_PROFEST2020.pdf' target="_blank">Manual de llenado Plataforma PROFEST 2020</a><span class="glyphicon glyphicon-share" aria-hidden="true"></span>
              </div>
            </div>
            <div class="form-group">
              <div class="col-sm-offset-3 col-sm-9" align="right">
                <a href='formatos_para_descarga_general/TRIPTICO_VF.pdf' target="_blank">Triptico PROFEST</a><span class="glyphicon glyphicon-share" aria-hidden="true"></span>
              </div>
            </div>
            <div class="form-group">
              <div class="col-sm-offset-3 col-sm-9" align="right">
