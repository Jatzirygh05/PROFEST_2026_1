      ...
      <div class="row">
        <div class="col-md-8">
          <div>
            ...
            <?php /*h2 id="objetivo">Iniciar sesión</h2*/?>
          </div>
          <div class="alert alert-warning">

            <?php /*div id="countdown"></div*/ ?>
            <strong>¡Aviso!</strong> Estimado usuario por el momento la plataforma está cerrada.
              
          </div>
          <?php /*form class="form-horizontal ns_" role="form" name="form1" method="post" action="<?php echo $loginFormAction; ?>">
