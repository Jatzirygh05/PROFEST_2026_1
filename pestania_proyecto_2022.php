                    ...
                    <tr>
                      ...
                      <td>
                       <?php if($f<=3){ ?><samp id="errorganigrama_correo<?=$f?>As" name="errorganigrama_correo<?=$f?>As" class="control-label" style="display:none">*</samp><?php } ?>
                        <input type="text" id="organigrama_correo<?=$f?>" name="organigrama_correo<?=$f?>" id="organigrama_correo<?=$f?>" value="<?=$organigrama_correo_a?>" class="form-control proyectocampo" placeholder="ejemplo@dominio.com" onblur="validarEmailorg(organigrama_correo<?=$f?>);">
