          ...
          <table class="table table-bordered">
            ...
            <?php for($f=1;$f<=10;$f++){ ?>
              <tbody>
                ...
                <td>
                  <input class="form-control" placeholder="Municipio1" type="Municipio donde se realizara el festival">
                </td>
                <td>
                  <input class="form-control" placeholder="Municipio2" type="Municipio donde se realizara el festival">
                </td>
                <td>
                  <input class="form-control" placeholder="Municipio3" type="Municipio donde se realizara el festival">
                </td>
                <td>
                  <input class="form-control" placeholder="Municipio4" type="Municipio donde se realizara el festival">
                </td>
                <td>
                  <input class="form-control" placeholder="Municipio5" type="Municipio donde se realizara el festival">
                </td>
                <td>
                  <input class="form-control" placeholder="Municipio6" type="Municipio donde se realizara el festival">
                </td>
              </tr>
            </tbody>
          <?php } ?>
