                    ...
                    <tr>
                      ...
                      <td>
                       <?php if($f<=3){ ?><samp id="errorganigrama_correo<?=$f?>As" name="errorganigrama_correo<?=$f?>As" class="control-label" style="display:none">*</samp><?php } ?>
                        <input type="text" id="organigrama_correo<?=$f?>" name="organigrama_correo<?=$f?>" id="organigrama_correo<?=$f?>" value="<?=$organigrama_correo_a?>" class="form-control proyectocampo" placeholder="ejemplo@dominio.com" onblur="validarEmailorg($organigrama_correo_a);">
    ...
    <!-- inicio de la pestaña Desarrollo del Proyecto dentro de Proyecto -->
      <div class="row">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group"> 
              <label>Nombre del festival<samp id="errnombre_festivalAs" name="errnombre_festivalAs" class="control-label">*</samp>:</label><small> El nombre del proyecto que aquí se registre deberá ser el mismo con el que se difundirá, y será el que se tomará en cuenta para el proceso de convenio y no podra ser modificado en ninguna de las etapas siguientes.</small><input type="text" id="nombre_festival" name="nombre_festival" class="form-control segunampo" value="<?=$nombre_festival?>" placeholder="Ingresa el nombre del festival" maxlength="96"><small id="errnombre_festival" name="errnombre_festival" class="form-text form-text-error" style="display:none">Este campo es obligatorio</small>
      ...
      <!-- fin Entidad(es) -->
        <!-- fin de la pestana de lugar de Realización-->
      <div class="tab-pane" id="tab-15">
      <!--Inicio de pestaña de metas-->
