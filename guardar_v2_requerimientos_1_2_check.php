...
if($opcion1==""){
		  ...
		  $cuantos1=mysqli_num_rows($resultado);
		   if($cuantos1==1){
		  	...
		  	$query_1a = "DELETE FROM reque_v2_1_2 WHERE clave_usuario='$cve_user' and tipo=1;";
		  	$insert_1a = mysqli_query($con, $query_1a);
		   }
} else {
		 $query_user1="SELECT * FROM v2_requerimientos_elegidos WHERE clave_usuario='".$cve_user."' and tipo=1;";                          			 
		 $resultado = mysqli_query($con, $query_user1);
...
if($opcion2==""){
		  ...
		  $cuantos2=mysqli_num_rows($resultado);
		   if($cuantos2==1){
		  	...
		  	$query_2a = "DELETE FROM reque_v2_1_2 WHERE clave_usuario='$cve_user' and tipo=2;";
		  	$insert_2a = mysqli_query($con, $query_2a);
		   }
} else {
		 $query_user2="SELECT * FROM v2_requerimientos_elegidos WHERE clave_usuario='".$cve_user."' and tipo=2;";                          			 
		 $resultado = mysqli_query($con, $query_user2);
...
if($opcion3==""){
		  ...
		  $cuantos3=mysqli_num_rows($resultado);
		   if($cuantos3==1){
		  	...
		  	$query_3a = "DELETE FROM reque_v2_1_2 WHERE clave_usuario='$cve_user' and tipo=3;";
		  	$insert_3a = mysqli_query($con, $query_3a);
		   }
} else {
		 $query_user3="SELECT * FROM v2_requerimientos_elegidos WHERE clave_usuario='".$cve_user."' and tipo=3;";                          			 
		 $resultado = mysqli_query($con, $query_user3);
...
if($opcion4==""){
		  ...
		  $cuantos4=mysqli_num_rows($resultado);
		   if($cuantos4==1){
		  	...
		  	$query_4a = "DELETE FROM reque_v2_1_2 WHERE clave_usuario='$cve_user' and tipo=4;";
		  	$insert_4a = mysqli_query($con, $query_4a);
		   }
} else {
		 $query_user4="SELECT * FROM v2_requerimientos_elegidos WHERE clave_usuario='".$cve_user."' and tipo=4;";                          			 
		 $resultado = mysqli_query($con, $query_user4);
...
if($opcion5==""){
		  ...
		  $cuantos5=mysqli_num_rows($resultado);
		   if($cuantos5==1){
		  	...
		  	$query_5a = "DELETE FROM reque_v2_1_2 WHERE clave_usuario='$cve_user' and tipo=5;";
		  	$insert_5a = mysqli_query($con, $query_5a);
		   }
} else {
		 $query_user5="SELECT * FROM v2_requerimientos_elegidos WHERE clave_usuario='".$cve_user."' and tipo=5;";                          			 
		 $resultado = mysqli_query($con, $query_user5);
...
if($opcion6==""){
		  ...
		  $cuantos6=mysqli_num_rows($resultado);
		   if($cuantos6==1){
		  	...
		  	$query_6a = "DELETE FROM reque_v2_1_2 WHERE clave_usuario='$cve_user' and tipo=6;";
		  	$insert_6a = mysqli_query($con, $query_6a);
		   }
} else {
		 $query_user6="SELECT * FROM v2_requerimientos_elegidos WHERE clave_usuario='".$cve_user."' and tipo=6;";                          			 
		 $resultado = mysqli_query($con, $query_user6);
...
if($opcion7==""){
		  ...
		  $cuantos7=mysqli_num_rows($resultado);
		   if($cuantos7==1){
		  	...
		  	$query_7a = "DELETE FROM reque_v2_1_2 WHERE clave_usuario='$cve_user' and tipo=7;";
		  	$insert_7a = mysqli_query($con, $query_7a);
		   }
} else {
		 $query_user7="SELECT * FROM v2_requerimientos_elegidos WHERE clave_usuario='".$cve_user."' and tipo=7;";                          			 
		 $resultado = mysqli_query($con, $query_user7);
...
if($opcion8==""){
		  ...
		  $cuantos8=mysqli_num_rows($resultado);
		   if($cuantos8==1){
		  	//echo "borrar 8<br>";
		  	$query_8 = "DELETE FROM v2_requerimientos_elegidos WHERE clave_usuario='$cve_user';";
		  	$insert_8 = mysqli_query($con, $query_8);

		  	$query_8a = "DELETE FROM honorarios_artisticos_academicos_v2 WHERE clave_usuario='$cve_user' and tipo=8;";
		  	$insert_8a = mysqli_query($con, $query_8a);
		   }
} else {
		 $query_user8="SELECT * FROM v2_requerimientos_elegidos WHERE clave_usuario='".$cve_user."' and tipo=8;";                          			 
		 $resultado = mysqli_query($con, $query_user8);
...
/*if($opcion9==""){
		  ...
		  $cuantos9=mysqli_num_rows($resultado);
		   if($cuantos9==1){
		  	//echo "<br><br>borrar 9<br>";
		  	$query_9 = "DELETE FROM v2_requerimientos_elegidos WHERE clave_usuario='$cve_user' and tipo=9;";
		  	$insert_9 = mysqli_query($con, $query_9);

		  	$query_9a = "DELETE FROM reque_v2_1_2 WHERE clave_usuario='$cve_user' and tipo=9;";
		  	$insert_9a = mysqli_query($con, $query_9a);
		   }
} else {
		 $query_user9="SELECT * FROM v2_requerimientos_elegidos WHERE clave_usuario='".$cve_user."' and tipo=9;";                          			 
		 $resultado = mysqli_query($con, $query_user9);
...
if($opcion10==""){
		  $query_user10="SELECT * FROM v2_requerimientos_elegidos WHERE clave_usuario='".$cve_user."' and tipo=10;";                          			 
		  $resultado = mysqli_query($con, $query_user10);
		  $cuantos10=mysqli_num_rows($resultado);
		   if($cuantos10==1){
		  	//echo "<br><br>borrar 9<br>";
		  	$query_10 = "DELETE FROM v2_requerimientos_elegidos WHERE clave_usuario='$cve_user' and tipo=10;";
		  	$insert_10 = mysqli_query($con, $query_10);

		  	$query_10a = "DELETE FROM reque_v2_1_2 WHERE clave_usuario='$cve_user' and tipo=10;";
		  	$insert_10a = mysqli_query($con, $query_10a);
		   }
} else {
		 $query_user10="SELECT * FROM v2_requerimientos_elegidos WHERE clave_usuario='".$cve_user."' and tipo=10;";                          			 
		 $resultado = mysqli_query($con, $query_user10);
		 $cuantos10=mysqli_num_rows($resultado);
		   if($cuantos10==0){
			  //echo "inserta 10<br>";
			  $query_10 = "INSERT INTO v2_requerimientos_elegidos(clave_usuario, tipo, fecha_hora_registro) VALUES ('$cve_user', 10, NOW());";
			  $insert_10 = mysqli_query($con, $query_10);
		   }
}
if($opcion11==""){
		  $query_user11="SELECT * FROM v2_requerimientos_elegidos WHERE clave_usuario='".$cve_user."' and tipo=11;";                          			 
		  $resultado = mysqli_query($con, $query_user11);
		  $cuantos11=mysqli_num_rows($resultado);
		   if($cuantos11==1){
		  	//echo "<br><br>borrar 9<br>";
		  	$query_11 = "DELETE FROM v2_requerimientos_elegidos WHERE clave_usuario='$cve_user' and tipo=11;";
		  	$insert_11 = mysqli_query($con, $query_11);

		  	$query_11a = "DELETE FROM reque_v2_1_2 WHERE clave_usuario='$cve_user' and tipo=11;";
		  	$insert_11a = mysqli_query($con, $query_11a);
		   }
} else {
		 $query_user11="SELECT * FROM v2_requerimientos_elegidos WHERE clave_usuario='".$cve_user."' and tipo=11;";                          			 
		 $resultado = mysqli_query($con, $query_user11);
		 $cuantos11=mysqli_num_rows($resultado);
		   if($cuantos11==0){
			  //echo "inserta 10<br>";
			  $query_11 = "INSERT INTO v2_requerimientos_elegidos(clave_usuario, tipo, fecha_hora_registro) VALUES ('$cve_user', 11, NOW());";
			  $insert_11 = mysqli_query($con, $query_11);
		   }
}
...
//echo "REGISTROS GUARDADOS honorarios";
	echo "<META HTTP-EQUIV='Refresh' CONTENT='0;URL=v2_honorarios_artisticos_academicos.php'>";
		...
		//$opcion1 or $opcion2 or $opcion3 or $opcion4 or $opcion5 or $opcion6 or $opcion7 or $opcion9
		if($opcion10 or $opcion11){
