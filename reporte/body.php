...
$pdf->SetFont('Arial','B',10);
	...
	$pdf->Ln(4);
	$pdf->Cell(4);
	$pdf->Cell(90,10,utf8_decode('dirigidas a grupos en situación de vulnerabilidad y/o aquellas acciones para contar con un espacio accesible'),0,0,'L');
	$pdf->Ln(4);
	$pdf->Cell(4);
	$pdf->Cell(90,10,utf8_decode('para todas y todos.'),0,0,'L');
	$pdf->Ln(8);
	$pdf->Cell(4);
	$pdf->SetFont('Arial','',10);
