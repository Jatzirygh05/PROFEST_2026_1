...
header("Content-Disposition: attachment; filename=Festival_Datos_Parte3_".date('d-m-Y').".xls");
...
<th><strong><font size=2 face=sans-serif> Monto de la inversion interna (Recursos propios) </font></strong></th>
<th><strong><font size=2 face=sans-serif> Monto de la inversion interna (Iniciativa privada) </font></strong></th>
<th><strong><font size=2 face=sans-serif> Objetivo </font></strong></th>
<th><strong><font size=2 face=sans-serif> Numero de actividades programadas </font></strong></th>
</tr>
';
				  ...
				  while( $arreg = mysqli_fetch_assoc($r))
				  {
					...
					$objetivo_general        				= $arreg["objetivo_general"];
					$meta_num_actividades_academicas       	= $arreg["meta_num_actividades_academicas"];
...
<td><font size=2 face=sans-serif> '.$Falta.' </font></td>
<td><font size=2 face=sans-serif> '.$objetivo_general.' </font></td>
<td><font size=2 face=sans-serif> '.$meta_num_actividades_academicas.' </font></td>
</tr>';
}
$return .= '
</table>';
