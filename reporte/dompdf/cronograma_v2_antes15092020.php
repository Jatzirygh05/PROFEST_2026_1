...
Alcaldía, Estado)-->
        <td width="90" align="center">Nombre del foro de presentación o medio de transmisión</td>
        <td width="20" align="center">Fecha presentación</td>
    ...
    <tr>
        ...
        <td align="center"><?=utf8_encode($fila['disciplina'])?></td>
        <td align="center"><?=utf8_encode($fila['nombre_artista_grupo'])?></td>
        <td align="center"><?=utf8_encode($fila['estado_origen_artista_grupo'])?>, <?=utf8_encode($fila['municipio_origen_artista_grupo'])?></td>
        <td align="center">
         <?php /* , <?=utf8_encode($fila['localidad_foro'])?>, <?=utf8_encode($fila['municipio_alcaldia_foro'])?>, <?=utf8_encode($fila['estado_foro'])*/?>          <?=utf8_encode($fila['nombre_presentacion'])?></td>
        <td align="center"><?=utf8_encode($fila['nombre_foro'])?></td>
        ...
        <td align="center"><?=utf8_encode($fila['duracion_espectaculo_propuesto'])?></td>
    ...
    <tr>
        ...
        <td align="right"><?=$prog_confirmada?>%</td>
    </tr>
</table>
<?php 
...
if($clave3!='' or $clave4!=''){ //INICIO 3, 4 Derechos en general, Seguridad ?>
    ...
    <table border="0" width="100%">
        ...
        <table border="1" cellpadding="0" cellspacing="0" align="center">
          <tr bgcolor="#CCCCCC">
            <td rowspan="2" align="center">No.</td>
            <td colspan="3" align="center">Derechos en general</td>
          </tr>
          <tr bgcolor="#CCCCCC">
            <td align="center">Concepto</td>
            <td align="center">Unidad</td>
          ...
          <?php
            ...
            while($fila_3=mysqli_fetch_array($res_user_3, MYSQLI_ASSOC)){
                  $h=$h+1; 
                  $total_esp_3=$fila_3['total_esp_mue_inmue'];                                  
          ?>
          <tr>
            <td align="center"><?php echo $h; ?></td>
            <td align="center"><?php echo $fila_3['concepto']; ?></td>
            <td align="center"><?php echo $fila_3['unidad']; ?></td>
            <td align="right">$<?php echo number_format($fila_3['monto_tot_imp_incluidos'],2,'.',','); ?></td>
          <?php } ?>
          <tr>
            <td colspan="2">&nbsp;</td>
            <td align="center">Total</td>
        ...
        <table border="1" cellpadding="0" cellspacing="0" align="center">
          <tr bgcolor="#CCCCCC">
            <td rowspan="2" align="center">No.</td>
            <td colspan="4" align="center">Seguridad(Incluye gastos médicos, traslados de obra, instrumentos, etc.)</td>
          </tr>
          <tr bgcolor="#CCCCCC">
            <td align="center">Concepto</td>
            <td align="center">Unidad</td>
          ...
          <?php
            ...
            while($fila_4=mysqli_fetch_array($res_user_4, MYSQLI_ASSOC)){
                  $h=$h+1; 
                  $total_esp_4=$fila_4['total_esp_mue_inmue'];                                  
          ?>
          <tr>
            <td align="center"><?php echo $h; ?></td>
            <td align="center"><?php echo $fila_4['concepto']; ?></td>
            <td align="center"><?php echo $fila_4['unidad']; ?></td>
            <td align="right">$<?php echo number_format($fila_4['costo_unitario_imp_incluidos'],2,'.',','); ?></td>
            <td align="right">$<?php echo number_format($fila_4['monto_tot_imp_incluidos'],2,'.',','); ?></td>
          <?php } ?>
          <tr>
            <td colspan="3">&nbsp;</td>
            <td align="center">Total</td>
...
<table border="0" width="100%">
  <tr>
    ...
    <table border="1" cellpadding="0" cellspacing="0" align="center">
      <tr bgcolor="#CCCCCC">
        <td rowspan="2" align="center">No.</td>
        <td rowspan="2" align="center">Nombre del (los) participantes (s)</td>
        <td colspan="2" align="center">Transportación aérea de las/os participantes(No se cubren pérdidas de boletos, cambios de itinerarios, exceso de equipaje, ni acompañantes)</td>
        </tr>
      <tr bgcolor="#CCCCCC">
        <td align="center">Origen-Destino-Origen</td>
        <td align="center">Monto total impuestos incluidos(M.N.)</td>
      </tr>
      <?php
        ...
        while($fila_5=mysqli_fetch_array($res_user_5, MYSQLI_ASSOC)){
              $h=$h+1; 
              $total_esp_5=$fila_5['total_esp_mue_inmue'];                                  
      ?>
      <tr>
        <td><?php echo $h; ?></td>
        <td><?php echo $fila_5['nombre_participantes']; ?></td>
        <td><?php echo $fila_5['origen_destino_origen']; ?></td>
        <td align="right">$<?php echo number_format($fila_5['monto_tot_imp_incluidos'],2,'.',','); ?></td>
      <?php } ?>
      </tr>
      <tr>
        <td colspan="2">&nbsp;</td>
    ...
    <table border="1" cellpadding="0" cellspacing="0" align="center">
      ...
      <?php
          ...
          <tr>
            <td align="center"><?php echo $h; ?></td>
            <td align="center"><?php echo $fila_6['concepto']; ?></td>
            <td align="center"><?php echo $fila_6['unidad']; ?></td>
            <td align="right">$<?php echo number_format($fila_6['costo_unitario_imp_incluidos'],2,'.',','); ?></td>
            <td align="right">$<?php echo number_format($fila_6['monto_tot_imp_incluidos'],2,'.',','); ?></td>
          <?php } ?>
          <tr>
            <td colspan="3">&nbsp;</td>
            <td align="center">Total</td>
            <td align="right">$<?php echo number_format($total_esp_6,2,'.',','); ?></td>
      </tr>
      <tr>
        <td colspan="3">&nbsp;</td>
        <td align="center">Total General</td>
...
<table border="1" cellpadding="0" cellspacing="0" align="center">
    ...
    <?php
            ...
            while($fila_7=mysqli_fetch_array($res_user_7, MYSQLI_ASSOC)){
                  $h=$h+1; 
                  $total_esp_7=$fila_7['total_esp_mue_inmue'];                                  
          ?>
          <tr>
            <td align="center"><?php echo $h; ?></td>
            <td align="center"><?php echo $fila_7['concepto']; ?></td>
            <td align="center"><?php echo $fila_7['unidad']; ?></td>
            <td align="right">$<?php echo number_format($fila_7['costo_unitario_imp_incluidos'],2,'.',','); ?></td>
            <td align="right">$<?php echo number_format($fila_7['monto_tot_imp_incluidos'],2,'.',','); ?></td>
          <?php } ?>
          <tr>
            <td colspan="3">&nbsp;</td>
            <td align="center">Total</td>
...
<table border="1" cellpadding="0" cellspacing="0" align="center">
    <tr bgcolor="#CCCCCC">
        <td rowspan="2" align="center">No.</td>
        <td colspan="4" align="center">Corte vinil para stands de exposición y/o foros</td>
    </tr>
    <tr bgcolor="#CCCCCC">
        <td align="center">Concepto</td>
        <td align="center">Unidad</td>
    ...
    <?php
            ...
            while($fila_9=mysqli_fetch_array($res_user_9, MYSQLI_ASSOC)){
                  $h=$h+1; 
                  $total_esp_9=$fila_9['total_esp_mue_inmue'];                                  
          ?>
          <tr>
            <td align="center"><?php echo $h; ?></td>
            <td align="center"><?php echo $fila_9['concepto']; ?></td>
            <td align="center"><?php echo $fila_9['unidad']; ?></td>
            <td align="right">$<?php echo number_format($fila_9['costo_unitario_imp_incluidos'],2,'.',','); ?></td>
            <td align="right">$<?php echo number_format($fila_9['monto_tot_imp_incluidos'],2,'.',','); ?></td>
          <?php } ?>
          <tr>
            <td colspan="3">&nbsp;</td>
            <td align="center">Total</td>
...
$pdf = $dompdf->output();
$filename = "Cronograma_presupuesto_programacion.pdf";
