...
<table border="1" cellpadding="0" cellspacing="0" align="center">
    <tr bgcolor="#CCCCCC">
        ...
        <td width="90" align="center">Estado de origen</td>
...
Alcaldía, Estado)-->
    ...
    <tr>
        ...
        <td align="center"><?php echo utf8_encode($fila['estado_origen_artista_grupo']); ?>, <?php echo utf8_encode($fila['municipio_origen_artista_grupo']); ?></td>
        <td align="center">
         <?php /* , <?=utf8_encode($fila['localidad_foro'])?>, <?=utf8_encode($fila['municipio_alcaldia_foro'])?>, <?=utf8_encode($fila['estado_foro'])*/?>          <?php echo $fila['nombre_present_o_servicio']; ?></td>
        ...
        $lugar_sel=$fila['lugar_sel'];
               ...
               $result = mysqli_query($con, $query);
                     ...
                     { 
                        ...
                        if($lugar_sel==$valor){ echo $imp_texto; }
                    }
