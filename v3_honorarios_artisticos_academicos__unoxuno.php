        ...
        <div class="col-md-8"> 
          <table>
            ...
            <tr bgcolor="#DDDDDD">
              <td rowspan="2">#</td>
              <td colspan="3"></td>
              <td colspan="10"><center>Datos de la o el Artista o Grupo entro </center></td>
            ...
            <tr>
              <?php
                $query_user10 = "SELECT * FROM honorarios_artisticos_academicos_v2_unoxuno WHERE clave_usuario='".$cve_user."' 
                order by id;";                          
