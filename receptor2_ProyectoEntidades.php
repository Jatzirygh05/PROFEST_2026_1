...
$resultado="SELECT clave_usuario FROM proyecto_entidades_municipios WHERE `clave_usuario` = '".$cve_user."' ;";
...
mysqli_set_charset($con, 'utf8');
			...
			if($cuantos_id>=1){
					...
					$q_modifica="UPDATE `proyecto_entidades_municipios` SET $variable='$valor', 
					...
					$exe_modifica=mysqli_query($con, $q_modifica);
						...
						//echo "----INSERTA REGISTRO----";
								$q_inserta="INSERT INTO `proyecto_entidades_municipios` (`clave_usuario`,
