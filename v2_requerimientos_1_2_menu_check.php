  ...
  <div class="row">
    ...
    $variable_guarda = 0;
       $query_user1="SELECT * FROM v2_requerimientos_elegidos WHERE clave_usuario='".$cve_user."';";                          			 
        ...
        $clave10 = array_search('10', $separa);
        $clave11 = array_search('11', $separa); 
		?>
     <div class="col-md-4">    
      ...
      <div class="checkbox">
          <label>
            <input type="checkbox" name="opcion8" id="opcion8" onclick="javascript:validar(this);" <?php if($clave8!=""){ ?> checked <?php } ?> value="8"> 8. Contratación de servicios profesionales de artistas, conferencistas, talleristas y grupos nacionales
            <!--Honorarios artísticos y académicos -->
          </label>
      </div>
      <div class="checkbox">
          <label>
            <input type="checkbox" name="opcion8" id="opcion10" onclick="javascript:validar(this);" <?php if($clave10!=""){ ?> checked <?php } ?> value="10"> 10. Uso de medios de comunicación para la transmisión de las actividades programadas
          </label>
      </div>
      <div class="checkbox">
          <label>
            <input type="checkbox" name="opcion8" id="opcion11" onclick="javascript:validar(this);" <?php if($clave11!=""){ ?> checked <?php } ?> value="11"> 11. Uso de medios de comunicación para la transmisión de las actividades programadas
          </label>
      </div>
      <?php /*if($disciplina_artes_visuales_v2==1 || $disciplina_literatura_v2==1){?>
        <div class="checkbox">
