...
//se comento el 05/12/2025 para pruebas -->if($cve_user==""){ echo "<META HTTP-EQUIV='Refresh' CONTENT='2;URL=index_cierre.php'>";}
...
<!DOCTYPE html>
  ...
  <head>
    ...
    <![endif]-->
      ...
      <!-- comentado 05/12/2025 para pruebas script type="text/javascript" src="js/reloj_regresivo_cierre_pruebas.js"></script-->
			...
			if(total_entre_losdos==cuantos_doctos_cargo){
				...
				if(confirm("¿Desea concluir tu registro?")) { 
					   if(confirm("¿Estás seguro?  \n\n Una vez concluido ya no podrás agregar o modificar información.")){
						   //bien para finalizar 16092020 var url = 'finsol_continua_proceso.php' ----index_cierre.php
...
<input name="fecha_propuesta<?php echo $id; ?>" type="text" id="fecha_propuesta <?php echo $id; ?>" size="20" maxlength="150" class="Estilo1" onkeyup = "this.value=formateafecha(this.value);" />
			...
			<div class="row">
            <div class="col-md-12"><!--index_cierre.php-->
...
<!--script>
var end = new Date('05/07/2021 03:30 PM');
