		...
		<div class="modal-dialog">
			<div class="modal-content">					
					...
					<div class="modal-body">
							...
							<select class='form-control' name='archivo_nombre' id='archivo_nombre' onchange="mostrar(this.value);">
								...
								while ($fila_doctos_d=mysqli_fetch_array($res_doctos_d, MYSQLI_ASSOC)){
													...
													$nombre_documento_d=utf8_encode($fila_doctos_d['nombre_documento']);
								...
								if($Info_financiera_categoria=="D"){
									   ...
									   $tipo_formato='';
								?>
								<option value='<?=$id_docto_d?>'><?php echo $nombre_documento_d.' ('.$tipo_formato_d.')'?></option>
								<?php 
									}
								}
								?>
                 ...
                 <div class="row">
                        ...
                        <label>Descarga formato*:</label>
                        <a href="reporte/dompdf/cronograma_v2.php" target="blank">Formato de cronograma, presupuesto y programación PROFEST</a>
                        </div>
