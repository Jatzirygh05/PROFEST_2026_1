...
?>
    ...
    <form METHOD="POST" id="apInf" name="apInf" action="guardar_acceso.php">
        ...
        <div class="alert alert-warning">
                    <p><strong>¡Sugerencia!</strong> Antes de iniciar su registro, le recomendamos usar los siguientes navegadores: Chrome, Firefox, Safari, o la última versión de Explorer.</p>
         </div>
    </div>
...
<!-- *********************PRIMERA PARTE********************* -->
        ...
        <div class="row">
        	...
        	<div class="col-md-4"> 
        		<div class="form-group">
                    ...
                    <select id="tipo_de_instancia" name="tipo_de_instancia" class="form-control">
                        ...
                        <?php //option value="Organización de la Sociedad Civil">Organización de la Sociedad Civil</option?>
                    </select>
            ...
            <!-- Campo Nombre de la Instancia Postulante -->
                <div class="col-md-4">
                    <div class="form-group"> 
                        <label> Nombre de la Instancia Postulante<samp id="errNombre_InstAs" name="errNombre_InstAs" class="control-label">*</samp>:</label>
              ...
              <div class="row">
               <!-- Campo Nombre de la o el Títular -->
                <div class="col-md-4">
                    <div class="form-group"> 
                        <label> Nombre de la o el Títular<samp id="errnombre_titularAs" name="errnombre_titularAs" class="control-label">*</samp>:</label>
                ...
                <div class="col-md-4">
                    <div class="form-group"> 
                        <label> Primer apellido<samp id="errprimer_apellidoAs" name="errprimer_apellidoAs" class="control-label">*</samp>:</label>
                        <input type="text" id="primer_apellido" name="primer_apellido" class="form-control" placeholder="Ingresa el primer apellido de la o el Títular">
                        <small id="errprimer_apellido" name="errprimer_apellido" class="form-text form-text-error" style="display:none">Este campo es obligatorio</small>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group"> 
                        ...
                        <input type="text" id="segundo_apellido" name="segundo_apellido" class="form-control" placeholder="Ingresa el segundo apellido de la o el Títular">
                        <small id="errsegundo_apellido" name="errsegundo_apellido" class="form-text form-text-error" style="display:none">Este campo es obligatorio</small>
                    </div>
                </div>
           </div>
           <div class="row">                
           <div class="col-md-4">
                    <div class="form-group"> 
                        <label> Grado académico<samp id="errgradoAs" name="errgradoAs" class="control-label">*</samp>:<span class="glyphicon glyphicon glyphicon-question-sign" aria-hidden="true" data-placement="left" title="Grado académico de la o el Títular, en el caso de no contar con grado académico, agregar Ciudadana/o"></span></label>
                        <?php //input type="text" id="grado" name="grado" class="form-control" placeholder="Ingresa el grado académico de la o el Títular"?>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" id="PostCodRepLeg" name="PostCodRepLeg" class="form-control" placeholder="Ingresa el código postal" onBlur="cargaContenido4(this.id)" onKeyPress="return soloNumeros(event)" maxlength="5">
        ...
        <div class="row">  
            ...
            <div class="col-md-4">
                <div class="form-group clearfix">
                  ...
                  <div class="form-control-lada">
                    ...
                    <input type="text" id="LadaRepLeg" name="LadaRepLeg" class="form-control" placeholder="Lada" onKeyPress="return soloNumeros(event)">   
                  ...
                  <div class="form-control-phone">
                    ...
                    <input type="text" id="TelefonoRepLeg" name="TelefonoRepLeg" class="form-control" placeholder="Telefono fijo" onKeyPress="return soloNumeros(event)">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label>Correo electrónico<samp id="errCorreoAs" name="errCorreoAs" class="control-label">*</samp>:<span class="glyphicon glyphicon glyphicon-question-sign" aria-hidden="true" data-placement="left" title="Correo electrónico de la o el Títular"></span></label><input type="text" id="Correo" name="Correo" class="form-control" placeholder="ejemplo@dominio.com" onBlur="validarEmail(this.id);">
         ...
         <?php /*div class="row">  
        	...
        	<div class="col-md-4">
                <div class="form-group">
                    <label>CLUNI:<span class="glyphicon glyphicon glyphicon-question-sign" aria-hidden="true" data-placement="left" title="Número de registro federal asignado por INDESOL"></span></label><input type="text" id="CLUNI" name="CLUNI" class="form-control" placeholder="Ingresa el CLUNI" disabled>
                </div>
            </div>
        </div>
		...
		<div class="row">
        	<div class="col-md-4">
                <div class="form-group">
                    <label>Nombre del Organismo de la Sociedad Civil:</label><input type="text" id="nombre_ONG" name="nombre_ONG" class="form-control" placeholder="Ingresa el Nombre" disabled>
                </div>
            </div>
        </div*/?>
