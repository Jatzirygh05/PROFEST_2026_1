...
<!DOCTYPE html>
  ...
  <head>
    ...
    <title>Convocatoria Profest 2024</title>
          ...
          <form class="form-horizontal ns_" role="form" name="form1" method="post" action="<?php echo $loginFormAction; ?>">
            ...
            <div class="form-group">
              <div class="col-sm-offset-3 col-sm-9" align="right">
                <a href='formatos_para_descarga_general/Manual_llenado_Plataforma_PROFEST2023.pdf' target="_blank">Manual de llenado Plataforma PROFEST 2023</a><span class="glyphicon glyphicon-share" aria-hidden="true"></span>
              </div>
            </div>
            <!--div class="form-group">
              <div class="col-sm-offset-3 col-sm-9" align="right">
            ...
            <!--div class="form-group"> esto es lo unico que hay que habilitar para 2024
              <div class="col-sm-offset-3 col-sm-9" align="right">
