...
$tipo_lugar=(isset($_POST['tipo_lugar'])?$_POST['tipo_lugar']:NULL); 
...
$numero=(isset($_POST['numero'])?$_POST['numero']:NULL);
    ...
    if($num_existe>=1){
       ...
       $query_insert_nuevo="UPDATE mas_lugares SET tipo_lugar='$tipo_lugar', Nombreforo='$Nombreforo', 
            cpforo='$cpforo',
