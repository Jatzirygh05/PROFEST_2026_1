            ...
            <!-- Campo Nombre de la Instancia Postulante -->
                ...
                <div class="col-md-4">
                    <div class="form-group"> 
                        ...
                        <small id="rowError_num_ediciones" name="rowError_num_ediciones" class="form-text form-text-error" style="display:none">De acuerdo a la convocatoria solo podrán participar festivales de segunda emisión en adelante.</small>
                    </div>
                </div>
                  ...
                  <div class="form-group"> 
                       <label> Categoría en la que participa<samp id="errinfo_financiera_categoriaAs" name="errinfo_financiera_categoriaAs" class="control-label">*</samp>:</label>
                        ...
                        <select id="info_financiera_categoria" name="info_financiera_categoria" class="form-control cat_categoria">
                            <option value="" selected="selected">Selecciona una opción</option>
                            <option value="A" <?php if($Info_financiera_categoria=="A"){ ?> selected="selected" <?php } ?>>A) Festivales de segunda y tercera emisión, hasta 500,000 pesos.</option>
                            <option value="B" <?php if($Info_financiera_categoria=="B"){ ?> selected="selected" <?php } ?>>B) Festivales de cuarta a séptima emisión, hasta 1,500,000 pesos.</option>
                            <option value="C" <?php if($Info_financiera_categoria=="C"){ ?> selected="selected" <?php } ?>>C) Festivales de octava a decimoprimera emisión, hasta 3 millones de pesos.</option>
                            <option value="D" <?php if($Info_financiera_categoria=="D"){ ?> selected="selected" <?php } ?>>D) Festivales de decimosegunda emisión en adelante, hasta 5 millones.</option>
                    	</select>
      ...
      <!-- FIN PESTAÑA "Solicitud" -->  
        ...
        <div class="col-md-4">
        		<div class="form-group">
        				...
        				<input type="text" id="meta_num_foros" name="meta_num_foros" class="form-control segunampo" value="<?=$meta_num_foros?>" placeholder="Ingresa n&uacute;mero de foros" onKeyPress="return soloNumeros(event)">
           ...
           <div class="col-md-4">
                ...
                <div class="form-group clearfix">
                  ...
                  <div class="form-control-phone">
                    ...
                    <input type="text" id="telefono_fijo_op" name="telefono_fijo_op" value="<?=$telefono_fijo_op?>" class="form-control proyectocampo" placeholder="Teléfono fijo">
           ...
           <div class="col-md-4">
                ...
                <div class="form-group clearfix">
                  ...
                  <div class="form-control-phone">
                    ...
                    <input type="text" id="telefono_fijo_adm" name="telefono_fijo_adm" value="<?=$telefono_fijo_adm?>" class="form-control proyectocampo" placeholder="Teléfono fijo">
         ...
         <div class="row">
          <div class="col-md-4">
           ...
           <div class="row">
			...
			<input class='form-control proyectocampo' type='text' name='Nombreforo_a' id='Nombreforo_a' value='<?=$Nombreforo_a?>' placeholder='Ingresa el nombre del foro'>
               ...
               <div class="row"> 
                    <div class="col-md-4"> 
                       <div class="form-group">
                        ...
                        <input class="form-control proyectocampo" id="cpforo_a" name="cpforo_a" placeholder="Ingresa el Código Postal" value="<?=$cpforo_a?>" type="text" onKeyPress="return evita_comas(event)">
                    ...
                    <div class="col-md-4"> 
                       <div class="form-group">
                        ...
                        <input class="form-control proyectocampo" id="estadoforo_a" name="estadoforo_a" placeholder="Ingresa el Estado" value="<?=$estadoforo_a?>" type="text">
                  ...
                  <label class="control-label" for="mun_alcforo_a">Municipio o Alcaldía<samp id="errmun_alcforo_aAs" name="errmun_alcforo_aAs" class="control-label">*</samp>:</label>
                        <input class="form-control proyectocampo" id="mun_alcforo_a" name="mun_alcforo_a" placeholder="Ingresa el Municipio o Alcaldía" value="<?=$mun_alcforo_a?>" type="text">
                    ...
                    <div class="col-md-4"> 
                       <div class="form-group">
                        ...
                        <input class="form-control proyectocampo" id="coloniaforo_a" name="coloniaforo_a" placeholder="Ingresa la colonia" value="<?=$coloniaforo_a?>" type="text">
                    ...
                    <div class="col-md-4"> 
                       <div class="form-group">
                        ...
                        <input class="form-control proyectocampo" id="calleforo_a" name="calleforo_a" placeholder="Ingresa la calle" value="<?=$calleforo_a?>" type="text">
                    ...
                    <div class="col-md-4"> 
                       <div class="form-group">
                        ...
                        <input class="form-control proyectocampo" id="no_extforo_a" name="no_extforo_a" placeholder="Ingresa el número externo" value="<?=$no_extforo_a?>" type="text">
                    ...
                    <div class="col-md-4"> 
                       <div class="form-group">
                        ...
                        <input class="form-control proyectocampo" id="no_intforo_a" name="no_intforo_a" placeholder="Ingresa el número interno" value="<?=$no_intforo_a?>" type="text">
                    ...
                    <div class="col-md-4"> 
                       <div class="form-group">
                         ...
                         <input class="form-control proyectocampo" id="Descripcionlug_a" name="Descripcionlug_a" value="<?=$Descripcionlug_a?>" placeholder="Ingresa la descripción" type="text">
             ...
             <div class="row">
               <div class="col-md-4"> 
                   <div class="form-group">
                    ...
                    <input class="form-control proyectocampo" id="Nombreforo_b" name="Nombreforo_b" placeholder="Ingresa el nombre del foro" value="<?=$Nombreforo_b?>" type="text">
                   </div>
               </div>
              </div>
              <div class="row"> 
                    <div class="col-md-4"> 
                       <div class="form-group">
                        ...
                        <input class="form-control proyectocampo" id="cpforo_b" name="cpforo_b" placeholder="Ingresa el Codigo Postal" value="<?=$cpforo_b?>" type="text" onKeyPress="return evita_comas(event)">
                    ...
                    <div class="col-md-4"> 
                       <div class="form-group">
                        ...
                        <input class="form-control proyectocampo" id="estadoforo_b" name="estadoforo_b" placeholder="Ingresa el Estado" value="<?=$estadoforo_b?>" type="text">
                  ...
                  <label class="control-label" for="mun_alcforo_b">Municipio o Alcaldía:</label>
                        <input class="form-control proyectocampo" id="mun_alcforo_b" name="mun_alcforo_b" placeholder="Ingresa el Municipio o Alcaldía" value="<?=$mun_alcforo_b?>" type="text">
                    ...
                    <div class="col-md-4"> 
                       <div class="form-group">
                        ...
                        <input class="form-control proyectocampo" id="coloniaforo_b" name="coloniaforo_b" placeholder="Ingresa la colonia" value="<?=$coloniaforo_b?>" type="text">
                    ...
                    <div class="col-md-4"> 
                       <div class="form-group">
                        ...
                        <input class="form-control proyectocampo" id="calleforo_b" name="calleforo_b" placeholder="Ingresa la calle" value="<?=$calleforo_b?>" type="text">
                    ...
                    <div class="col-md-4"> 
                       <div class="form-group">
                        ...
                        <input class="form-control proyectocampo" id="no_extforo_b" name="no_extforo_b" placeholder="Ingresa el número exterior" value="<?=$no_extforo_b?>" type="text">
                    ...
                    <div class="col-md-4"> 
                       <div class="form-group">
                        ...
                        <input class="form-control proyectocampo" id="no_intforo_b" name="no_intforo_b" placeholder="Ingresa el número interior" value="<?=$no_intforo_b?>" type="text">
	               ...
	               <div class="col-md-4"> 
	                   <div class="form-group">
	                    	...
	                    	<input class="form-control proyectocampo" id="Descripcionlug_b" name="Descripcionlug_b" value="<?=$Descripcionlug_b?>" placeholder="Ingresa la descripción" type="text">
	                   </div>
	               </div>
            </div>
            <div class="row">
	            <div class="col-md-4"> 
                    <div class="form-group">
        	            ...
        	            <input class="form-control proyectocampo" id="Nombreforo_c" name="Nombreforo_c" placeholder="Ingresa el nombre del foro" value="<?=$Nombreforo_c?>" type="text">
                    </div>
                   </div>
            </div>
            <div class="row">
                    <div class="col-md-4"> 
                       <div class="form-group">
                        ...
                        <input class="form-control proyectocampo" id="cpforo_c" name="cpforo_c" placeholder="Ingresa el Código Postal" value="<?=$cpforo_c?>" type="text" onKeyPress="return evita_comas(event)">
                    ...
                    <div class="col-md-4"> 
                       <div class="form-group">
                        ...
                        <input class="form-control proyectocampo" id="estadoforo_c" name="estadoforo_c" placeholder="Ingresa el Estado" value="<?=$estadoforo_c?>" type="text">
                  ...
                  <label class="control-label" for="mun_alcforo_c">Municipio o Alcaldía:</label>
                        <input class="form-control proyectocampo" id="mun_alcforo_c" name="mun_alcforo_c" placeholder="Ingresa el Municipio o Alcaldía" value="<?=$mun_alcforo_c?>" type="text">
                    ...
                    <div class="col-md-4"> 
                       <div class="form-group">
                        ...
                        <input class="form-control proyectocampo" id="coloniaforo_c" name="coloniaforo_c" placeholder="Ingresa la colonia" value="<?=$coloniaforo_c?>" type="text">
                    ...
                    <div class="col-md-4"> 
                       <div class="form-group">
                        ...
                        <input class="form-control proyectocampo" id="calleforo_c" name="calleforo_c" placeholder="Ingresa la calle" value="<?=$calleforo_c?>" type="text">
                    ...
                    <div class="col-md-4"> 
                       <div class="form-group">
                        ...
                        <input class="form-control proyectocampo" id="no_extforo_c" name="no_extforo_c" placeholder="Ingresa el número exterior" value="<?=$no_extforo_c?>" type="text">
                    ...
                    <div class="col-md-4"> 
                       <div class="form-group">
                        ...
                        <input class="form-control proyectocampo" id="no_intforo_c" name="no_intforo_c" placeholder="Ingresa el número interior" value="<?=$no_intforo_c?>" type="text">
                	...
                	<div class="col-md-4"> 
                    	<div class="form-group">
                        	...
                        	<input class="form-control proyectocampo" id="Descripcionlug_c" name="Descripcionlug_c" value="<?=$Descripcionlug_c?>" placeholder="Ingresa la descripción" type="text">
                   		</div>
               	 </div>
            </div>
