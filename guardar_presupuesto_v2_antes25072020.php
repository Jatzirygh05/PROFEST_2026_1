...
for($a=$cuantos_agrega;$a<=50;$a++){
	...
	if($Concepto_gasto_b!='' && $Fuente_finan_b!='' && $Monto_unidad_b!='' && $Porcentaje_b!='')
	{
		...
		VALUES
		(NULL, '$cve_user', '$Concepto_gasto_b', '$Fuente_finan_b', '$Monto_unidad_b', '$Porcentaje_b', '$pres_anual_tot_2010', '$ene_suma',NOW());";
...
if($mod or $mod_c){
  ...
  echo "<META HTTP-EQUIV='Refresh' CONTENT='0;URL=v2_requerimientos_1_2_menu_check.php'>";
}
