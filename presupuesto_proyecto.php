...
<!DOCTYPE html>
  ...
  <head>
    ...
    <title>Convocatoria PROFEST 2021</title>
    <!-- CSS -->
...
<body>
     <div class="container">
        <div class="row">
 		...
 		<div class="row">
          <div class="col-sm-8">
            <h1>Convocatoria PROFEST 2021</h1>
          </div>
        </div>
...
<div class="row">
                    <div class="col-md-12"> 
                        <h3> ñ) Resumen presupuestal</h3>
                        <p><strong>Use este espacio para registrar un resumen presupuestal sobre el costo total del proyecto (considerando la coinversión de la instancia postulante), usando al menos 3 conceptos de gasto que se enlistan en el combo al seleccionar el campo.
                        </strong></p>
                        <p>Se recomienda consultar la Convocatoria para conocer los conceptos en los que podrá emplearse el recurso PROFEST.</p> 
<p>El monto total que resulte del registro de <strong>Institucional Federal PROFEST</strong> como fuente de financiamiento, deberá ser igual al monto solicitado a la Secretaría de Cultura.</p>
                    </div>
