$(document).on('click', '#Guardar_Servidor_P', function(){
    ...
    var expr = /^[a-zA-Z0-9]*$/;
        ...
        if(tipo_lugar==1){ 
        if(Nombreforo=="" || cpforo=="" || estadoforo=="" || mun_alcforo=="" || 
            coloniaforo=="" || calleforo=="" || no_extforo=="" || no_intforo=="" || Descripcionlug==""){
...
function modificarServidorP(id_lugares,numero){
    ...
    var tipo="modificar";
    var nombre_tipo=$("#tipo_lugar"+numero).val();
    ...
    if(nombre_tipo=="Foro"){ var tipo_lugar=1; } else{ var tipo_lugar=2; }
