...
var end = new Date('12/28/2023 06:00 PM');
    var _second = 1000;
    ...
    function showRemaining() {
        ...
        document.getElementById('countdown').innerHTML = '<strong>¡Aviso! </strong>Estimado usuario, el registro de proyectos a la plataforma PROFEST 2024 concluirá en<strong> ' + hours + ' horas, ' + minutes + ' minutos y </strong>';  
