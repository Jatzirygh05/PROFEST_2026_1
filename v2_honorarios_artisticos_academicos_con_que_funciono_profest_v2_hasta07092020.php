  ...
  function suma_vertical(id){
    ...
    function suma_vertical_general(){
      ...
      var total_proyecto = document.formul.total_proyecto.value;
       ...
       //+ parseFloat(apoyo_general_paso.replace(/[$,\s]/g, ''))
       suma_general = parseFloat(total_apoyo_suma.replace(/[$,\s]/g, '')) ;
    ...
    <form name="formul" action="guardar_v2_formatos_honorarios.php" method="post">
     <div class="container">
          ...
          <div class="row">
          	<div class="col-sm-12">
              <p>
              Usa este espacio para registrar todos los datos de las o los artistas, conferencias, talleristas y grupos nacionales a contratarse con el recurso PROFEST. 
              </p>
              <p>
        ...
        <div class="col-md-8"> 
          <table>
            ...
            <tr bgcolor="#F6F6F6">
              ...
              <td><span class="es inline-block">Horario (HH:MM:SS a.m/p.m)*</span></td>
            ...
            <tr>
                ...
                ?>
                 ...
                 <?php $disciplina = utf8_encode($fila10['disciplina']); ?>
                  ...
                  <td><select name="espacio_requerido<?php echo $h; ?>" id="espacio_requerido<?php echo $h; ?>" class="form-control">
                      ...
                      <option value="Otro" <?php if ($fila10['espacio_requerido']=='Otro'){?> selected <?php } ?>>Otro</option>
                      </select></td>                                
                  ...
                  <td><input type="text" class="form-control" name="nombre_foro<?php echo $h; ?>" id="nombre_foro<?php echo $h; ?>" value="<?php echo utf8_encode($fila10['nombre_foro']); ?>" placeholder="Ingresa" style="width: 350px;" /></td>
                  <?php /*td><input type="text" class="form-control" name="estado_foro<?php echo $h; ?>" id="estado_foro<?php echo $h; ?>" value="<?php echo utf8_encode($fila10['estado_foro']); ?>" placeholder="Ingresa" /></td>
              ...
              <input type="text" class="form-control" name="sinopsis<?php echo $h; ?>" id="sinopsis<?php echo $h; ?>" value="<?php echo utf8_encode($fila10['sinopsis']); ?>" placeholder="Ingresa" maxlength="600">
                  ...
                  <td>
  <input type="text" class="form-control" name="monto_honorarios_imp_inc_mn<?php echo $h; ?>" id="monto_honorarios_imp_inc_mn<?php echo $h; ?>" value="<?php echo $fila10['monto_honorarios_con_impuestos_incluidos_mn']; ?>" onChange="suma_vertical(<?php echo $i; ?>);" placeholder="Ingresa" onKeyPress="return evita_comas(event)" /></td>
                ...
                <tr>
                  ...
                  <?php /*td><input type="text" class="form-control" name="estado_foro<?php echo $i; ?>" id="estado_foro<?php echo $i; ?>" placeholder="Ingresa" /></td>
                  <td>
                  ...
                  <td><input type="text" class="form-control" name="monto_honorarios_imp_inc_mn<?php echo $i; ?>" id="monto_honorarios_imp_inc_mn<?php echo $i; ?>" onChange="suma_vertical(<?php echo $i; ?>);" placeholder="Ingresa" /></td>
                ...
                <?php /*suma_vertical_general();tr> 
                  <td colspan="32" align="right"></td>
                  <td><?php 
                ...
                <tr> 
                  <td colspan="32" align="right">Suma total de conceptos registrados: </td>
                ...
                <div class="row top-buffer">
                           ...
                           <input type="hidden" name="tipo_elegidos" id="tipo_elegidos" value="<?php echo $num_sql_elegidos?>">
                            <?php /*
                                  ...
                                  $resultado_10seleccionado = mysqli_query($con, $query_user10);
                                  $cuantos10_seleccionado = mysqli_num_rows($resultado_10seleccionado);
                                  if($cuantos10_seleccionado==1){
                            ?>
                           <input type="hidden" name="opcion10" id="opcion10" value="10">
                            <?php } else { ?>
                          <input type="hidden" name="opcion10" id="opcion10" value="">
                            <?php } 
                                  $query_user11="SELECT * FROM v2_requerimientos_elegidos WHERE clave_usuario='".$cve_user."' and tipo=11;";
                                  $resultado_seleccionado = mysqli_query($con, $query_user11);
                                  $cuantos11_seleccionado = mysqli_num_rows($resultado_seleccionado);
                                  if($cuantos11_seleccionado==1){
                            ?>
                           <input type="hidden" name="opcion11" id="opcion11" value="11">
                         <?php } else { ?>
                          <input type="hidden" name="opcion11" id="opcion11" value="">
                         <?php } */?>
